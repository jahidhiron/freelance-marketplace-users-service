...
import { BadRequestError, IEducation, IExperience, ISellerDocument } from '@jahidhiron/jobber-shared';
...
export const seed = async (req: Request, res: Response): Promise<void> => {
  ...
  for (let i = 0; i < buyers.length; i++) {
    ...
    const seller: ISellerDocument = {
      ...
      socialLinks: ['https://jahid-academy.com', 'http://youtube.com', 'https://facebook.com'],
      certificates: [
        {
